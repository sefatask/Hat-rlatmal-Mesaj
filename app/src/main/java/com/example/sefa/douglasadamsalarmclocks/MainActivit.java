...
public class MainActivit extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        final Intent intent12 = getIntent();
        if(intent12.hasExtra("message")) {
            String mesag = intent12.getStringExtra("message");
            if (mesag.equalsIgnoreCase("info")) {
                AlertDialog.Builder alert = new AlertDialog.Builder(this);
                alert.setTitle("MESAJI GONDERELIM MI?");
                ...
                alert.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivit.this,"MESAJ IPTAL EDILDI.",Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void btn_SendSMS_OnClick(){
        ...
        final String message="dfhfh";
        final String number="05072905884";
